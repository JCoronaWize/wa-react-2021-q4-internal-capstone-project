...
export const SingleProductInfo = ({productData}) => {
  return (        <MainContainer>
    ...
    <ContentContainer>
      <div className="info-container">
        <InfoLabel htmlFor="productName" title="productName">{productData[0].name}</InfoLabel>
        <InfoLabel htmlFor="" title="productPrice">$ {productData[0].price} US</InfoLabel>
        <InfoLabel htmlFor="" title="productSKU">SKU: {productData[0].sku}</InfoLabel>
        <InfoLabel htmlFor="" title="productCategory">
        ...
        <ul>
          <InfoLabel title="productTags">Tags:</InfoLabel>
      ...
      <div className="info-container">
        <InfoLabel title="productDescription">Description: </InfoLabel>
  ...
  return (
    <>
      ...
      {!productLoading && !productError && (
        <SingleProductInfo productData={productData}></SingleProductInfo>
        // <MainContainer>
        //   <GalleryContainer>
        //   <SwiperGallery imagesData={productData[0].images}></SwiperGallery>
        //   </GalleryContainer>
